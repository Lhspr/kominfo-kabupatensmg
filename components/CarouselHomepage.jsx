  ...
  return (
    <div className="flex justify-center my-20">
      ...
      <div className="flex w-full max-w-screen-xl">
        {/* Sidebar */}
        <div className="w-1/4 p-4 bg-white shadow-md rounded-lg"> {/* Changed background to white */}
          <ul className="space-y-2">
            <li className="flex items-center p-4 rounded-lg bg-white hover:bg-[#007bff] transition dark:bg-[#f0f0f0] dark:hover:bg-[#007bff]">
              <FaPaperPlane className="text-[#007bff] mr-3" size={24} /> {/* Changed icon color to blue */}
              <div>
            ...
            <li className="flex items-center p-4 rounded-lg bg-white hover:bg-[#007bff] transition dark:bg-[#f0f0f0] dark:hover:bg-[#007bff]">
              <FaMicrophone className="text-[#007bff] mr-3" size={24} /> {/* Changed icon color to blue */}
              <div>
            ...
            <li className="flex items-center p-4 rounded-lg bg-white hover:bg-[#007bff] transition dark:bg-[#f0f0f0] dark:hover:bg-[#007bff]">
              <FaBullhorn className="text-[#007bff] mr-3" size={24} /> {/* Changed icon color to blue */}
              <div>
